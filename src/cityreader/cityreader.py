...
cities_file = open('cities.csv', newline="")
cities_csv = csv.DictReader(cities_file)
cities = [row for row in cities_csv]
""" print(cities[0]) """

def cityreader(city_list=[]):
  # TODO Implement the functionality to read from the 'cities.csv' file
  # For each city record, create a new City instance and add it to the 
  # `cities` list
    cities = [City(city["city"], city["lat"], city["lng"]) for city in city_list]
